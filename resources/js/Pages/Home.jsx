            ...
            <div className="relative min-h-screen bg-gray-900 text-white">
                ...
                <div className="container mx-auto px-4 py-16 flex flex-col items-center justify-center">
                    ...
                    <p className="text-lg md:text-xl text-center max-w-2xl mb-12 text-gray-300">
                        Embark on a perilous journey through 100 levels of
                        dungeon madness. Battle fearsome enemies, upgrade your
                        skills, and see how far you can go before the darkness
                        claims you. Will you reach the final level and become a
                        legend?
                    </p>
